...
function Parents() {
  ...
  const handleEdit = (index: number) => {
    // Set the form data to the selected parent's data for editing
  ...
  const handleDelete = (index: number) => {
    // Remove the selected parent record
    const updatedParents = [...parents];
                ...
                <div className="mb-4">
                  <div className="flex mb-6">
                    <div className="w-1/2 mb-6 mr-4">
                      <label className="block text-inputgrey mb-1">Parent Name</label>
                      <input
                    ...
                    <div className="w-1/2">
                      <label className="block text-inputgrey mb-1">Phone Number</label>
                      <input
                        className="border border-grey py-2 px-4 w-2/3 rounded"
                        type="text"
